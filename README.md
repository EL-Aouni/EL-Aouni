...
> **Setup required (one-time):** these stats are generated by a GitHub Action that commits a static image to this repo every day — see the setup steps below. Once it's run once, this image is permanent and never depends on a live external service.
