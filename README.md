...
```
[+] Currently building   : practical security tools in Python & complex network topologies
[+] Currently learning   : advanced pentesting techniques + Blue Team operations
[+] Open to collab on    : open-source security projects, CTF teams, security research
[+] Looking for help with: reverse engineering & exploit development
[+] Ask me about         : network security, Python automation, vuln scanning, Cisco configs
```
...
![Cybersecurity](https://img.shields.io/badge/-CYBERSECURITY-000000?style=for-the-badge&logo=hackaday&logoColor=00FF41&labelColor=0d1117)
![Network Security](https://img.shields.io/badge/-NETWORK_SECURITY-000000?style=for-the-badge&logo=cisco&logoColor=00FF41&labelColor=0d1117)
![Python](https://img.shields.io/badge/-PYTHON-000000?style=for-the-badge&logo=python&logoColor=00FF41&labelColor=0d1117)
![Ethical Hacking](https://img.shields.io/badge/-ETHICAL_HACKING-000000?style=for-the-badge&logo=linux&logoColor=00FF41&labelColor=0d1117)
...
![Cisco](https://img.shields.io/badge/-Cisco-0d1117?style=for-the-badge&logo=cisco&logoColor=00FF41)
...
> anomaly detection for common attacks
> stack: Python · Scapy · Wireshark
```
[`→ view repo`](https://github.com/EL-Aouni)
...
> open ports + CVE cross-reference
> stack: Python · Nmap · CVE-DB
```
[`→ view repo`](https://github.com/EL-Aouni)
...
```
> multi-VLAN Cisco network sim
> routing, ACLs, firewall rules
> stack: Cisco · Packet Tracer · GNS3
```
[`→ view repo`](https://github.com/EL-Aouni)
...
**🚩 ctf-writeups**
```
> solved CTF challenge archive
> web exploitation, RE, crypto
> stack: various
```
[`→ view repo`](https://github.com/EL-Aouni)
...
<br>
<div align="center">
<img src="https://github-profile-trophy.vercel.app/?username=EL-Aouni&theme=darkhub&no-frame=true&row=1&column=7"/>
</div>
</details>
...
[![X](https://img.shields.io/badge/-X-0d1117?style=for-the-badge&logo=x&logoColor=00FF41)](https://x.com/YOUR-HANDLE)

<br>

![Profile Views](https://komarev.com/ghpvc/?username=EL-Aouni&color=00ff41&style=for-the-badge&label=TRANSMISSIONS+RECEIVED)
